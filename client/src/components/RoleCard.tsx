...
export const RoleCard: React.FC<RoleCardProps> = ({ roleName, roleType, description, onDismiss }) => {
  ...
  const getRoleColor = () => {
    switch (roleType) {
      ...
      case RoleType.DEMONHUNTER: return 'bg-cyan-800 border-cyan-500';
      case RoleType.KNIGHT: return 'bg-yellow-900 border-yellow-500';
      case RoleType.GRAVEDIGGER: return 'bg-amber-900 border-amber-600';
      ...
      case RoleType.WHITEMAIDEN: return 'bg-sky-900 border-sky-200';
      case RoleType.WOLFWITCH: return 'bg-fuchsia-900 border-fuchsia-500';
